...
Author: Aviation Data Processing Team
Version: 6.0
Date: 2025-04-27
"""
...
def detect_flight_segments(track_points: List[TrackPoint], 
                          ...
                          distance_threshold: float = 50.0) -> List[List[TrackPoint]]:  # km - if no altitude, use distance
    """
    Detect individual flight segments from a continuous track
    Returns list of lists of TrackPoint objects
...
Examples:
  # Process single file
  python flight_route_splitter_v6.py -i flights_day1.kml -a airports.txt -o routes.kml
  
  # Process multiple files (for multi-day routes)
  python flight_route_splitter_v6.py -i day1.kml day2.kml day3.kml -a airports.txt -o routes.kml
